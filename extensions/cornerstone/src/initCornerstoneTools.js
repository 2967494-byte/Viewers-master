...
import CenterCrossTool from './tools/CenterCrossTool';
import VerticalScaleOverlayTool from './tools/VerticalScaleOverlayTool';
import FocalPointCrossTool from './tools/FocalPointCrossTool';
...
export default function initCornerstoneTools(configuration = {}) {
  ...
  addTool(CenterCrossTool);
  addTool(VerticalScaleOverlayTool);
  addTool(FocalPointCrossTool);
...
const toolNames = {
  ...
  CenterCross: CenterCrossTool.toolName,
